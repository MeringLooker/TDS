...
#    hidden: yes
   ...
   dimension: campaign {
    ...
    sql:
      CASE
        WHEN ${campaign_name} = 'MC_TDSC_Sales_Skills' then 'LI_Sales_Skills'
        WHEN ${campaign_name} = 'FY19_TDSC_Sales_JobTitles' then 'LI_Sales_JobTitles'
        WHEN ${campaign_name} = 'FY19_TDSC_Sales_Groups' then 'LI_Sales_Groups'
        ELSE 'Uncategorized'
        END
        ;;
  }

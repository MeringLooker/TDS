view: pdt_gdn {
    derived_table: {
      explore_source: tds_gdn {
        ...
        column: campaign {field: tds_gdn_ga_view.campaign}
        ...
        column: total_impressions {field: tds_gdn_ga_view.total_impressions}
        column: total_clicks {field: tds_gdn_ga_view.total_clicks}
        column: total_cost {field: tds_gdn_ga_view.total_cost}
        column: total_sessions {field: tds_gdn_ga_view.total_sessions}
        column: total_session_duration {field: tds_gdn_ga_view.total_session_duration}
